...
- [A0. Prioritize everybody's fun above all else.](community-rules.md)
- [A1. ERP is NOT allowed.](community-rules.md)
- [A2. Quantum Blue is a community server first and foremost. Be respectful.](community-rules.md)
- [A3. Current-rounding is forbidden.](community-rules.md)
- [A4. Respect the AHelp chat.](community-rules.md)
- [A5. Do not abuse exploits.](community-rules.md)

## Game Server Rules {#game-rules}

These rules apply within the context of rounds.

- [B1. Roleplay a believable character.](game-rules.md)
- [B2. Respect the Metashield.](game-rules.md)
- [B3. Powergaming guidelines.](game-rules.md)
- [B4. Escalation.](game-rules.md)
- [B5. Self-antagging.](game-rules.md)

## Command, Security, and Station AI Guidelines {#role-rules}

These rules apply within rounds for specific roles.

- [C1. Mindshielded roles](role-rules.md)
- [C2. Station AI](role-rules.md)
- [C3. Antagonist guidelines](role-rules.md)
...
- [S1. Silicons definition](silicon-rules.md)
